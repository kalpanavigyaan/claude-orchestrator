/**
 * QueuePanel — per-session instruction queue.
 *
 * Instructions are delivered one at a time to the session automatically once
 * it becomes idle after completing its current task. Think of it as a TODO
 * list for Claude: each item is sent as a user message when the session next
 * goes idle.
 *
 * Items can be typed inline or loaded from a .md / .txt file.
 */
